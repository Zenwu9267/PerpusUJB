                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Anggota.php?aksi=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Jurusan <small style="color: red;">* Wajib diisi</small></label>
                                                            <select class="form-control" name="kElas">
                                                                ...
                                                                <!-- S1 -->
                                                                <option value="Tenik Sipil">Teknik Sipil</option>
            ...
            <form action="pages/function/Anggota.php?aksi=tambah" enctype="multipart/form-data" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Jurusan <small style="color: red;">* Wajib diisi</small></label>
                        <select class="form-control" name="kelas">
                            <option disabled selected>-- Harap Pilih Jurusan --</option>
                            <!-- S1 -->
                            <option value="Tenik Sipil">Teknik Sipil</option>
                            <option value="Teknik Mesin">Teknik Mesin</option>
                            <option value="Informatika">Informatika</option>
                            ...
                            <!-- Magister -->
                             <option disabled>------------------------------------------</option>
                             <option value="Magister Hukum">Magister Hukum</option>
                             <option value="Magister Teknik Sipil">Magister Teknik Sipil</option><option value="Magister Manajemen">Magister Manajemen</option>
                        </select>
                    </div>
                    <div class="form-group">
